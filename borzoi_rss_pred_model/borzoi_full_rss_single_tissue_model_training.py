...
def train_model(train_gene_based_model_data, val_gene_based_model_data, test_index, learning_rate, l2_variant_reg_strength, variant_encoder_architecture, max_epochs=100, use_held_out_genes_for_validation=True):
...
def evaluate_model(variant_encoder, gene_based_model_data, train_gene_based_model_data, val_gene_based_model_data, test_gene_based_model_data, test_tissue_index, model_training_output_stem):
...
def main():
	...
	# Evaluate
	evaluate_model(variant_encoder, gene_based_model_data, train_gene_based_model_data, val_gene_based_model_data, test_gene_based_model_data, test_tissue_index, model_training_output_stem)
	# Save model results
